...
int main(void)
{
    ...
    build_data(&data, "tests/input_data_1400-1400.txt", "\t", nips, nops);
            ...
            && ((error / data.rows) > 0.00001); it++)
    {
        ...
        nn_save(&net, "work_1400-1400.net");
    }
    char fname[100];
    snprintf(fname, sizeof(fname), "work_1400-1400-%f.net", error / data.rows);
    nn_save(&net, fname);
    return 0;
}
